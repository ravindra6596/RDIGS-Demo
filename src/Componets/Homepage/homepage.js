          ...
          <div className="container">
            <div className="row">
              ...
              >
                <img
                  src={modalimg}
                  className="homemain-modalimg img-fluid"
                  alt=""
                />
              </div>
              <div className="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                ...
                <div style={{ display: "flex", marginTop: "5px" }}>
                  ...
                  <p className="homemodalAgree">
                    I agree to receive marketing & promotional emails by RD Info
                    Global Solutions.Check our{" "}
                    <span style={{ color: "#30a6e9" }}>Privacy Policy</span> And{" "}
                    <span style={{ color: "#30a6e9" }}>
                      Terms and Codition.
                    </span>{" "}
                  </p>
                </div>
