                                                        ...
                                                        <h2 className="text-center model-head-cop">Corporate Deck 2021</h2>
                                                            <form onSubmit={handleSubmit(onSubmit)} autocomplete="off">
                                                              ...
                                                              <i className="fa fa-user"></i>
                                                                <input type="text" {...register("name")} className="form-corporateDeck-fname" id="Fname" placeholder="Enter Your Name" required autocomplete="off"/>
                                                                </div>
                                                                <div className="corporate-form-in3">
                                                                <i className="fa fa-phone"></i>
                                                                <input type="number" {...register("contact")} className="form-corporateDeck-number" id="Pnumber" placeholder="Phone Number" maxLength="10" required/>
                                                                </div>
                                                                <div className="corporate-form-in4">
                                                                <i className="fa fa-envelope" aria-hidden="true"></i>
                                                                <input type="email" {...register("email")} className="form-corporateDeck-email" id="Email" placeholder="Your Email" autocomplete="off" required/>
                                                                </div>
                                                                <div className="corporate-form-in5">
                                                                <i className="fa fa-address-book" aria-hidden="true"></i>
                                                                <input type="text" {...register("company_name")} className="form-corporateDeck-company" id="Company" placeholder="Company Name" autocomplete="off" required/>
                                                                </div>
