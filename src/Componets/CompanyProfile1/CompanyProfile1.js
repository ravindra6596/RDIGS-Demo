  ...
  const userdata = [
    {
      ...
      vmpimg: ourvision,
      vmppara:
        "To provide highest quality added services to our purchasers and delivering measurable results. individual customers.learn more.",
    },
    {
      heading: "MISSION",
      vmpimg: ourmission,
    ...
    },
    {
      ...
      vmpimg: ourprincipal,
      vmppara:
        "Client Value Creation, Integrity &amp; Transparency, Authenticity and Excellence are the core values of RD info Solutions.",
    },
  ];
  const blogdata = [
    {
    ...
    },
    {
      ...
      h4sub1: "The Superman",
      slidep:
        "Best known for his operations, client management and customer service work. Ajay is the superman of our team. He handles the entire RDIGS operations. He has adapted the operational techniques and methodologies that allow RDIGS to excel in performance and gather appreciation from our clients. ",
    },
    {
      slidimg: companypro3,
        ...
        <div className="container">
          <div className="row">
            ...
            >
              ...
              <p style={{ color: "white" }}>
                {" "}
                we’re on a mission to help our clients deliver innovative
                experiences and drive value for their business
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-4 vmp-col">
                  ...
                  <div className="vision-div">
                    ...
                    <div className="vmp-paradiv">
                      <p className="company-vmp" data-aos="zoom-in">
                        {data.vmppara}
                      </p>
                    </div>
                  </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              ...
              ></Heading>
              <p>
                Choosing a solutions provider that understands your business’
                needs can feel overwhelming; we’re here to tell you that it
                doesn’t have to be.
              </p>
            </div>
                  ...
                  <Tab.Content className="tab-divfor-img">
                    <Tab.Pane eventKey="first">
                      <div className="first-div">
                        ...
                        <p className="text-light p-3">
                          With over 700+ certified and trained professionals,
                          Apisero designs custom-built solutions for mid-market,
                          enterprise, and strategic customers across the globe.
                        </p>
                      </div>
                    </Tab.Pane>
                    <Tab.Pane eventKey="second">
                      <div className="second-div">
                        <Heading
                          h1Class="clientheadwe"
                          title="Suite of Solutions"
                        ></Heading>
                        <p className="text-light p-3">
                          Develops tailored solutions that fit your
                          organization’s goals. From Architecture and
                          Implementation to Managed Services, Data Migration,
                          Advisory Services, and more, we’ve got you covered.
                        </p>
                      </div>
                    </Tab.Pane>
                    <Tab.Pane eventKey="third">
                      <div className="three-div">
                        ...
                        ></Heading>
                        <p className="text-light p-3">
                          Your company needs a solution, and you need it as
                          quickly and efficiently as possible. That’s why we
                          offer quick ramp-up and down times to ensure you’re
                          optimizing your business as soon as you can.
                        </p>
                      </div>
                    </Tab.Pane>
                    <Tab.Pane eventKey="four">
                      <div className="four-div">
                        ...
                        ></Heading>
                        <p className="text-light p-3">
                          Your partnership matters to us. That’s why Apisero
                          works with each customer to define a custom engagement
                          and pricing model that suits your business’ unique
                          needs.
                        </p>
                      </div>
                    </Tab.Pane>
                    <Tab.Pane eventKey="five">
                      <div className="five-div">
                        ...
                        ></Heading>
                        <p className="text-light p-3">
                          We know change can be scary, but with us, it doesn’t
                          have to be. We’ll work closely with your internal
                          teams to ensure they’re trained, enabled, and ready
                          for action.
                        </p>
                      </div>
                    </Tab.Pane>
                    <Tab.Pane eventKey="six">
                      <div className="six-div">
                        ...
                        <p className="text-light p-5">
                          Leveraging our extensive industry and platform
                          know-how, Apisero offers customers specialized
                          services that empower their business to capitalize on
