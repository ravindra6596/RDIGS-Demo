        ...
        <div className="container" data-aos="fade-up">
          ...
          <div className="row ">
            <div className="col-sm-1"></div>
              ...
              <div className="count-box founded-in" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="500">
                     <i className="fa fa-history"></i>
                <div className="text-center para-icons">
                  <p className="" data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-duration="2000">Founded In</p>
